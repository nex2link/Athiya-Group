...
import edu from "../assets/icons/edu-icon.png";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-8 sm:gap-12 relative">
        ...
        >
          ...
          <p className="text-gray-600 text-lg hidden sm:block transform transition-all duration-700 delay-200">
            Discover premium investment opportunities in one of India's
                ...
                >
                  {card.icon2 ? (
                    ...
                    <div className="flex gap-2">
                      <img src={card.icon2} className="w-14 h-10" alt="" />
                      <img src={card.icon} className="w-8 h-10 pt-4" alt="" />
